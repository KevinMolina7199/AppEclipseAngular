...
a persistence unit "BDan1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BDan1/pom.xml":
...
artifact ("BDan1.war") is already built. You can build
